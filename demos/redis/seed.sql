-- Seed fixture for the RESP-protocol demo stack (demos/redis/docker-compose.yml).
--
...
-- exist yet; demo.sh's PGRST.QUERY step still works either way since the
-- widgets table and its data are created unconditionally above.
