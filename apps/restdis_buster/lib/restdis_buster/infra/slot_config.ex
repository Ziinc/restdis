defmodule RestdisBuster.Infra.SlotConfig do
  @moduledoc false
  ...
  def slot_name do
    Application.get_env(:restdis_buster, :slot_name, "restdis_slot")
  end
  ...
  def publication_name do
    Application.get_env(:restdis_buster, :publication_name, "restdis_pub")
  end
  ...
  @spec az() :: String.t()
  def az do
    Application.get_env(:restdis_buster, :az, "local")
  end
  ...
  def replication_conn_opts do
    opts = Application.get_env(:restdis_buster, :replication_connection, [])
