defmodule SupaCacherBuster.TelemetryTest do
  ...
  test "Worker emits [:invalidation, :latency] after invalidate_by_row" do
    ...
    assert_receive {:telemetry, [:supa_cacher_buster, :invalidation, :latency], measurements,
                    metadata},
                   500
  ...
  test "Worker emits [:invalidation, :latency] after flush_table on truncate" do
    ...
    attach("test-inv-latency-trunc", [[:supa_cacher_buster, :invalidation, :latency]])
  ...
  test "received_at = nil yields duration_us = 0 (no crash)" do
    ...
    attach("test-nil-received", [[:supa_cacher_buster, :event, :processed]])
    ...
    assert_receive {:telemetry, [:supa_cacher_buster, :event, :processed], %{duration_us: 0}, _},
                   500
  end
end
