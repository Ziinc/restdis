defmodule SupaCacherBuster.Integration.WalInvalidationTest do
  @moduledoc """
  ...
  test "Tailer crash + restart resumes from last applied LSN (no event loss)", %{
    ...
    DynamicSupervisor.terminate_child(SupaCacherBuster.TailerSupervisor, tailer_pid)
  ...
  defp reset_replication_slot(conn) do
    ...
    case :syn.lookup(:wal, :wal_tailer) do
      {pid, _meta} when is_pid(pid) ->
        ...
        DynamicSupervisor.terminate_child(SupaCacherBuster.TailerSupervisor, pid)
