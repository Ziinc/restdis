defmodule RestdisServer.Integration.RewarmE2ETest do
  use ExUnit.Case
  ...
  setup do
    ...
    Application.put_env(:restdis_server, :stub_fetcher_body, [%{"e2e" => true}])
    ...
    on_exit(fn ->
      ...
      RestdisServer.Rewarm.stop_tenant(@tenant_id)
      InMemory.clear()
      Restdis.Cache.flush_tenant(@tenant_id)
      Agent.stop(agent)
    end)
