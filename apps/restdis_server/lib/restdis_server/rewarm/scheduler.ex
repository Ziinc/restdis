defmodule RestdisServer.Rewarm.Scheduler do
  @moduledoc """
  ...
  def start_link(opts) do
    ...
    GenServer.start_link(__MODULE__, opts,
      name: {:via, Registry, {RestdisServer.Rewarm.Registry, tenant_id}}
    )
  end
  ...
  def init(opts) do
    tenant_id = Keyword.fetch!(opts, :tenant_id)
    tick_ms = Application.get_env(:restdis_server, :rewarm_tick_ms, 500)
  ...
  defp process_due_entry(state, wire_key, entry, now) do
    ...
    if cold? do
      ...
      Task.Supervisor.start_child(RestdisServer.Rewarm.TaskSupervisor, fn ->
