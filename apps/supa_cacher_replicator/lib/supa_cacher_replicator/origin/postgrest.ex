defmodule SupaCacherReplicator.Origin.PostgREST do
  @moduledoc """
  ...
  defp request(dataset, config, params, headers) do
    ...
    extra = Application.get_env(:supa_cacher_replicator, :req_options, [])
  ...
  defp tenant_config(tenant_id) do
    case Application.get_env(:supa_cacher_replicator, :tenant_config_lookup) do
